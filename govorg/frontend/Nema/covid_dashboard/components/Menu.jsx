...
export  class Menu extends Component {
    ...
    render() {
        ...
        return (
            <div className="px-3 py-2 row infoTile">
                <div className="col-md-3 covid-border-right ">
                ...
                <div className="col-md-6 covid-border-right">
                ...
                <div className="col-12 lastUpdate">шинэчилсэн {onoodor_counts_obj['medeelel_shinchlegdsen_time']} өмнө</div>
            </div>
        )
    }
}
