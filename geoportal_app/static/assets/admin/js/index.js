...
// chart 1
  ...
  let chart1 = document.getElementById("dashboard-chart-1");
  if (chart1) {
...
// chart 2
  ...
  let chart2 = document.getElementById("dashboard-chart-2");
  if (chart2) {
...
// chart 3
  ...
  let chart3 = document.getElementById('dashboard-chart-3');
  if (chart3) {
...
// chart 4
  let chart4 = document.getElementById("dashboard-chart-4");
  if (chart4) {
  ...
  // chart 5
    let chart5 = document.getElementById("dashboard-chart-5");
    if (chart5) {
