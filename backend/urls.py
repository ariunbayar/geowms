...
urlpatterns = [
    ...
    path('another-database/', include(([
        ...
        path('mongo/tables/<int:pk>/all/', geoserver_another_database.mongo_sables_all),
        path('mongo/tables/remove/<int:root_id>/<int:pk>/', geoserver_another_database.mongo_sables_remove),
        path('mongo/tables/detail/<int:root_id>/<int:pk>/', geoserver_another_database.mongo_sables_detail),
        path('mongo/tables/<int:pk>/save/', geoserver_another_database.mongo_sables_save),
