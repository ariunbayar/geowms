...
export class Жагсаалт extends Component {
    ...
    paginate(page, query) {
        ...
        return service.govorgList(page, perpage, query, org_id).then((page) => {
            this.setState({
                govorg_list: page.items,
                govorg_length: page.items.length,
            });
            return page;
        });
    }
                        ...
                        {!this.state.is_form_open && (
                            <>
                                <div className="text-right">
                                    <NavLink
                                        className="btn gp-btn-primary float-right"
                                        to={`/back/байгууллага/түвшин/${org_level}/${org_id}/систем/үүсгэх/`}
                                    >
                                        Нэмэх
                                    </NavLink>
                                    <input
                                        ...
                                        placeholder="Хайх"
                                        onChange={(e) =>
                                            this.handleSearch("searchQuery", e)
                                        }
