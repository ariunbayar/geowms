...
export class PasswordChange extends Component {
    ...
    handleSave() {
        ...
        if (new_password === renew_password){
            const values = {"old_password": old_password, "new_password": new_password}
            service.passwordChange(values).then(({success, msg, error}) => {
                success ? null: msg = error
                            ...
                            <form>
                                <div className="form-group">
                                    <div className="position-relative has-icon-right">
                                        ...
                                        <input type="password" className="form-control form-control-rounded" disabled={this.state.is_save_success ? true : false} placeholder="Хуучин нууц үгээ оруулна уу" value={this.state.old_password} onChange={(e) => this.handleChange('old_password', e.target.value)}></input>
                                ...
                                <div className="form-group">
                                    <div className="position-relative has-icon-right">
                                        ...
                                        <input type="password" className="form-control form-control-rounded" disabled={this.state.is_save_success ? true : false} placeholder="Шинэ нууц үгээ оруулна уу" value={this.state.new_password} onChange={(e) => this.handleChange('new_password', e.target.value)}></input>
                                        <div className="form-control-position">
                                            <i className="icon-lock"></i>
                                        </div>
                                    </div>
                                ...
                                <div className="form-group">
                                    <div className="position-relative has-icon-right">
                                        ...
                                        <input type="password" className="form-control form-control-rounded" disabled={this.state.is_save_success ? true : false} placeholder="Шинэ нууц үгээ дахин оруулна уу" value={this.state.renew_password} onChange={(e) => this.handleChange('renew_password', e.target.value)}></input>
                                        <div className="form-control-position">
                                            <i className="icon-lock"></i>
                                        </div>
                                    </div>
                                </div>
                                {this.state.is_save_success !== null ?
                                    this.state.is_save_success ?
                                        <div className="alert alert-outline-success alert-dismissible alert-round" role="alert">
                                            ...
                                            <a href="/login/">Та дахин нэвтрэнэ үү.</a>
                                            </div>
                                        </div>
                                        :
                                ...
                                <button type="button" className={`btn btn-primary shadow-primary btn-round btn-block waves-effect waves-light ${this.state.save_btn_status === 'active' ? 'active' : 'disabled'}`} onClick={() => this.handleSave()}>Хадгалах</button>
                            </form>
                        </div>
                    </div>
                </div>
