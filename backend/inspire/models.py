...
class LPackages(models.Model):
    ...
    theme = models.ForeignKey(LThemes, on_delete=PROTECT, null=True)
    order_no = models.IntegerField(null=True)
    is_active = models.BooleanField(default=True, null=True)
    created_on = models.DateTimeField(auto_now_add=True, null=True)
    created_by = models.IntegerField(null=True)
...
class LFeatures(models.Model):
    ...
    package = models.ForeignKey(LPackages, on_delete=PROTECT, null=True)
    order_no = models.IntegerField(null=True)
    is_active = models.BooleanField(default=True, null=True)
    created_on = models.DateTimeField(auto_now_add=True, null=True)
    created_by = models.IntegerField(null=True)
...
class LDataTypeConfigs(models.Model):
    ...
    data_type = models.ForeignKey(LDataTypes, on_delete=PROTECT, null=True)
    property = models.ForeignKey(LProperties, on_delete=PROTECT, null=True)
    order_no = models.IntegerField()
    is_active = models.BooleanField(default=True)
    created_on = models.DateTimeField(auto_now_add=True)
    created_by = models.IntegerField()
...
class LFeatureConfigs(models.Model):
    ...
    feature = models.ForeignKey(LFeatures, on_delete=PROTECT, null=True)
