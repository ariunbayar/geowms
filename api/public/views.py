...
def _get_service_url(request, bundle, wms, url_type):
    url = reverse('api:service:wms_proxy', args=[bundle.pk, wms.pk, url_type])
...
def proxy(request, bundle_id, wms_id, url_type='wms'):
    ...
    if request.GET.get('REQUEST') == 'GetCapabilities':
        ...
        service_url = _get_service_url(request, bundle, wms, url_type)
